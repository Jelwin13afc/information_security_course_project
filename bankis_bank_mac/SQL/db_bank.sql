...
INSERT INTO `register` (`account_no`, `card_no`, `firstname`, `lastname`, `email`, `phone`, `acc_type`, `address1`, `address2`, `city`, `state`, `country`, `father`, `nationality`, `balance`,`type_user`) VALUES
(1101390073, 1234456, 'Demo', 'Demo', 'demo123@gmail.com', 1234567890, 'saving', '123, xyz colony', 'near abc', 'pqr', 'def', 'India', 'qwe', 'Indian', 992,'admin'),
(1143455119, 3252287008, 'lol', 'win', 'jelwin', 9113560056, 'saving', '#4-44/67, 4TH CROSS ROAD, PRASHANTH BAGH, ALAPE', '12345', 'PADIL', 'Karnataka', 'ssss', 'ffff', 'bbbb', 2000,'customer');
