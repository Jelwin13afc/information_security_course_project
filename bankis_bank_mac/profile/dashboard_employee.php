...
$result_mac = mysqli_query($con, "SELECT * FROM access_control WHERE user_type = '$acc_type'");
$row_mac = mysqli_fetch_array($result_mac,MYSQLI_ASSOC);

$dashboard=$row_mac['Dashboard'];
$profile=$$row_mac['Profile'];
$transfer_money=$row_mac['Transfer_Money'];
$transactions=$row_mac['transactions'];
$loan = $row_mac['loan'];
