...
<div class="topnav" id="myTopnav">
  ...
  <a href="dashboard_customer.php" class="active" ><i class="fa fa-fw fa-calculator "></i>Dashboard </a>
  <a href="profile_customer.php" ><i class="fa fa-fw fa-id-card-o "></i>Profie</a>
