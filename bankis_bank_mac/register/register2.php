  ...
  <form action="../db/register.php" method="post">
    ...
    <table width="80%" cellspacing="8">
      <tr>
		...
		<td>
          <select class="question" id="user_type" name="user_type" required autocomplete="off">
            <option value="admin">Admin(Confidential)</option>
            <option value="employee">Employee(Secret)</option>
			<option value="customer">Customer(Top Secret)</option>
          </select>
